...
class image_CRUD {
    ...
    protected function _insert_table($file_name, $relation_id = null)
    {
        ...
        $insert['user_id'] = get_logged_in_user_id();
	...
	protected function getState()
	{
		...
		{
			$upload_url = site_url('index.php/'.$rsegments_array[1].'/'.$rsegments_array[2].'/upload_file');
			$ajax_list_url  = site_url('index.php/'.$rsegments_array[1].'/'.$rsegments_array[2].'/ajax_list');
			$ordering_url  = site_url('index.php/'.$rsegments_array[1].'/'.$rsegments_array[2].'/ordering');
			$insert_title_url  = site_url('index.php/'.$rsegments_array[1].'/'.$rsegments_array[2].'/insert_title');
